...
!function (e, t) {
    ...
    "use strict";
    var t, n, o, r, a, i, u, c = {}, l = "querySelector" in document && "addEventListener" in e, s = {
        ...
        var n, o, r = t.charAt(0), a = "classList" in document.documentElement;
    ...
    c.animateScroll = function (n, o, i) {
        var c = y(o ? o.getAttribute("data-options") : null), l = f(t || s, i || {}, c),
            d = "[object Number]" === Object.prototype.toString.call(n) ? !0 : !1, h = d || !n.tagName ? null : n;
        if (d || h) {
            var m = e.pageYOffset;
            l.selectorHeader && !r && (r = document.querySelector(l.selectorHeader)), a || (a = O(r));
            var b, I, S = d ? n : p(h, a, parseInt(l.offset, 10)), E = S - m, A = v(), j = 0, L = function (t, r, a) {
                var i = e.pageYOffset;
...
!function (t, e, i, s) {
    ...
    var n = "stellar", r = {
        ...
        }(), c = f("transform"), p = t("<div />", {style: "background:#fff"}).css("background-position-x") !== s,
        h = p ? function (t, e, i) {
    ...
    o.prototype = {
        init: function () {
            ...
            var e = this, i = a[e.options.scrollProperty], s = l[e.options.positionProperty], o = i.setLeft,
                n = i.setTop;
            ...
            this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function () {
                var i, o, n, r, a, l, f, c, p, h = t(this), d = 0, u = 0, g = 0, m = 0;
            ...
            this.backgrounds = [], this.options.parallaxBackgrounds && (e = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (e = e.add(this.$element)), e.each(function () {
                var e, r, a, l, f, c, p, u = t(this), g = d(u), m = 0, v = 0, L = 0, _ = 0;
            ...
            var t, e, i, s, o, n, r, a, l, f, c = this._getScrollLeft(), p = this._getScrollTop(), d = !0, u = !0;
...
!function (a, b, c, d) {
    ...
    e.Defaults = {
        ...
        var b, c = this.settings, d = this._coordinates.length, e = Math.abs(this._coordinates[d - 1]) - this._width,
            f = -1;
...
(function () {
    ...
    "function" == typeof define && define.amd ? define(["eventEmitter/EventEmitter", "eventie/eventie"], function (n, i) {
        return t(e, n, i)
    }) : "object" == typeof exports || (e.imagesLoaded = t(e, e.EventEmitter, e.eventie))
    ...
    var a = e.jQuery, h = e.console, u = "undefined" != typeof h, d = Object.prototype.toString;
...
!function (a) {
    ...
    function e(b, c) {
        ...
        var h, i = this.each(function () {
            ...
            if (b.is("select")) {
                ...
                if (c) {
                    if (i) for (var k in i) i.hasOwnProperty(k) && (c.options[k] = i[k])
                } else {
    ...
    d.VERSION = "1.7.2", d.DEFAULTS = {
        ...
        constructor: d, init: function () {
            ...
            var p, q, r, s, b = this, c = this.$menu, d = this.$menuInner, e = a(window),
                f = this.$newElement[0].offsetHeight, g = this.sizeInfo.liHeight, h = this.sizeInfo.headerHeight,
                i = this.sizeInfo.searchHeight, j = this.sizeInfo.actionsHeight, k = this.sizeInfo.doneButtonHeight,
                l = this.sizeInfo.dividerHeight, m = this.sizeInfo.menuPadding, n = this.sizeInfo.menuExtras,
                o = this.options.hideDisabled ? ".disabled" : "", t = function () {
            ...
            if (t(), this.options.header && c.css("padding-top", 0), "auto" === this.options.size) {
                ...
                p = g * this.options.size + w * l + m, b.options.container ? (c.data("height") || c.data("height", c.height()), q = c.data("height")) : q = c.height(), b.options.dropupAuto && this.$newElement.toggleClass("dropup", r > s && p - n < q), c.css({
                    ...
                    overflow: "hidden",
                    "min-height": ""
                }), d.css({"max-height": p - m + "px", "overflow-y": "auto", "min-height": ""})
            }
        }, setWidth: function () {
            ...
            var e, f, b = this, c = "<div />", d = a(c), g = function (a) {
            ...
            var f, h, i, j, k, l, m, n, o, d = a(this), e = d.is("input") ? d.parent().parent() : d.parent(),
                g = e.data("this"), p = ":not(.disabled, .hidden, .dropdown-header, .divider)", q = {
                    32: " ",
                    48: "0",
                    49: "1",
                    50: "2",
...
function setSourceIfAvailable(a, b) {
    var c = a.nodeName.toLowerCase(), d = document.createElement("img");
...
function dynamicSwapImage(a, b) {
    var c = arguments.length <= 2 || void 0 === arguments[2] ? 1 : arguments[2], d = chooseCap(c);
    if (b && d > 1) {
...
function retina(a) {
    getImages(a).forEach(function (a) {
        if (!a.getAttribute(processedAttr)) {
            var b = "img" === a.nodeName.toLowerCase(), c = b ? a.getAttribute("src") : cleanBgImg(a),
                d = a.getAttribute("data-rjs"), e = !isNaN(parseInt(d, 10));
...
var hasWindow = "undefined" != typeof window, environment = hasWindow ? window.devicePixelRatio || 1 : 1,
    srcReplace = /(\.[A-z]{3,4}\/?(\?.*)?)$/, inlineReplace = /url\(('|")?([^\)'"]+)('|")?\)/i, selector = "[data-rjs]",
